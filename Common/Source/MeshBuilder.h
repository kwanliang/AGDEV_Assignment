...
public:
	...
	Mesh* GenerateCircle(const std::string &meshName, Color color, float length = 1.f);
	...
	Mesh* GenerateMinimapBorder(const std::string &meshName, Color color, float length = 1.f);
